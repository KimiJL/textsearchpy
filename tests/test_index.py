...
def test_tokenize():
    ...
    assert tokens == ['Iteratively', 'yield', 'tokens', 'as', 'unicode', 'strings', 'removing', 'accent', 'marks', 'and', 'optionally', 'lowercasing', 'the', 'unidoce', 'string', 'by', 'assigning', 'True', 'to', 'one', 'of', 'the', 'parameters', 'lowercase', 'to_lower', 'or', 'lower']
...
def test_append_doc():
    ...
    doc2 = Document(
        text="repository repeats words words words"
    )
    doc3 = Document(
        text="words and words and words"
    )
